...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 <form method="get" action="RechercheArchiveUser">
...
<a href="${pageContext.request.contextPath }/GetLoiAlgeriennePage" class="btn btn-outline-secondary">Parcourir la loi Algérienne</a>
<br>
<a href="${pageContext.request.contextPath }/GetArchivesPage" class="btn btn-outline-secondary" style="background-color:#3A1F35;color:white;">Archiver la loi algérienne</a>
<br>
