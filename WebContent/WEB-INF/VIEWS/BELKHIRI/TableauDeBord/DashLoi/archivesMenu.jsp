...
<a href="${pageContext.request.contextPath }/GetDashLoi" class="btn btn-outline-secondary">Parcourir la loi Algérienne</a>
<br>
<a href="${pageContext.request.contextPath }/GetDashArchive" class="btn btn-outline-secondary" style="background-color:#3A1F35;color:white;">Archives de la loi algérienne</a>
